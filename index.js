...
const descriptionString = `A total of $${totalRaised.toLocaleString()} has been raised across ${GAMES_JSON.length} ${GAMES_JSON.length === 1 ? 'game' : 'games'}. Currently, ${unfundedCount} ${unfundedCount === 1 ? 'game remains' : 'games remain'} unfunded.`;
